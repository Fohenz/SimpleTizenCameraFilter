...
void draw_santa(camera_preview_data_s* frame, const dlib::full_object_detection shape, imageinfo* imgarr);
void draw_nyan(camera_preview_data_s* frame, const dlib::full_object_detection shape, imageinfo* imgarr);
